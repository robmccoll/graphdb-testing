                    ...
                    double alpha, double beta)
{
  ...
  lrand48_generator randVals1(numedges);
  lrand48_generator randVals2(numedges);
  ...
  while (1)
  {
    ...
    numedgesToAdd = numedges - m;

    randVals1.generate(numedgesToAdd);
    randVals2.generate(numedgesToAdd);
  }

#ifdef DEBUG
  std::cout << "No. of undirected edges added: " << m << std::endl;
#endif
