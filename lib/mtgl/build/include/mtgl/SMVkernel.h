...
//    T* const a_values = a.values;           // Force MTA to place on stack.
  ...
  DenseVector<size_type, T> friend
  operator* <size_type, T> (size_type const, const DenseVector<size_type, T>&);

  DenseVector<size_type, T> friend
  operator* <size_type, T> (double const, const DenseVector<size_type, T>&);

  T friend
  operator* <size_type, T> (const DenseVector<size_type, T>&,
                            const DenseVector<size_type, T>&);

  DenseVector<size_type, T> friend
  diagonal <size_type, T> (const SparseMatrixCSR<size_type, T>&);

  DenseVector<size_type, T> friend
  Transpose_SMVm <size_type, T> (const SparseMatrixCSR<size_type, T>&,
                                 const DenseVector<size_type, T>&);
