...
template <typename G>
inline
typename transpose_adapter<G>::thread_vertex_iterator
thread_vertices(typename transpose_adapter<G>::size_type pos,
                const transpose_adapter<G>& tg)
{
  return thread_vertices(pos, tg.get_adapter());
}
...
template <typename G>
inline
typename transpose_adapter<G>::thread_adjacency_iterator
thread_adjacent_vertices(
    const typename transpose_adapter<G>::vertex_descriptor& v,
    typename transpose_adapter<G>::size_type pos,
    const transpose_adapter<G>& tg)
{
  return thread_adjacent_vertices(v, pos, tg.get_adapter());
}
...
template <typename G>
inline
typename transpose_adapter<G>::thread_in_adjacency_iterator
thread_in_adjacent_vertices(
    const typename transpose_adapter<G>::vertex_descriptor& v,
    typename transpose_adapter<G>::size_type pos,
    const transpose_adapter<G>& tg)
{
  return thread_in_adjacent_vertices(v, pos, tg.get_adapter());
}
...
template <typename G>
inline
typename transpose_adapter<G>::thread_edge_iterator
thread_edges(typename transpose_adapter<G>::size_type pos,
             const transpose_adapter<G>& tg)
{
  return thread_edges(pos, tg.get_adapter());
}
...
template <typename G>
inline
typename transpose_adapter<G>::thread_out_edge_iterator
thread_out_edges(const typename transpose_adapter<G>::vertex_descriptor& v,
                 typename transpose_adapter<G>::size_type pos,
                 const transpose_adapter<G>& tg)
{
  return thread_out_edges(v, pos, tg.get_adapter());
}
...
template <typename G>
inline
typename transpose_adapter<G>::thread_in_edge_iterator
thread_in_edges(const typename transpose_adapter<G>::vertex_descriptor& v,
                typename transpose_adapter<G>::size_type pos,
                const transpose_adapter<G>& tg)
{
  return thread_in_edges(v, pos, tg.get_adapter());
}
...
inline
typename transpose_adapter<G>::vertex_descriptor
null_vertex(const transpose_adapter<G>& tg)
{
  return null_vertex(tg.get_adapter());
}
...
null_edge(const transpose_adapter<G>& tg)
{
  return null_edge(tg.get_adapter());
}
...
inline
bool
is_valid(ITERATOR& iter, typename transpose_adapter<G>::size_type p,
         const transpose_adapter<G>& tg)
{
  return is_valid(iter, p, tg.get_adapter());
}
